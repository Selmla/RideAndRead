...
const NoScreen = ({ data }) => {
  ...
  return (
    <div style={{ animation: "fadeUp 0.5s ease both", textAlign: "center", padding: "60px 0" }}>
      ...
      <p style={{ fontFamily: "'Crimson Text', Georgia, serif", fontSize: "17px", color: "#707070", lineHeight: 1.7, margin: "0 0 40px" }}>
        {data.from} will understand.<br />Some stories take time to begin.
      </p>

      <div style={{ background: "#181818", border: "1px solid #2A2A2A", borderLeft: "3px solid #383838", borderRadius: "8px", padding: "20px", textAlign: "left" }}>
        <p style={{ fontSize: "10px", letterSpacing: "0.14em", color: "#686868", textTransform: "uppercase", fontFamily: "Georgia, serif", margin: "0 0 10px" }}>
          Let them know
        </p>
        <p style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "15px", color: "#707070", fontStyle: "italic", lineHeight: 1.6, margin: "0 0 16px" }}>
          "{replyText}"
        </p>
        <button onClick={sendReply} style={{
          width: "100%", padding: "14px", background: "transparent", border: "1px solid #383838",
          borderRadius: "6px", color: "#707070", fontFamily: "Georgia, serif", fontSize: "11px",
